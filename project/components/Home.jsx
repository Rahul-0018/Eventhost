...
const Home = () =>{
    return(
        ...
        <div className="head"><h1>The simplest way to host all your events</h1></div>
            <div className="box">
            <div className="boximg2"><h2>Product Launches</h2><h3>Experience innovation from the comfort of your screen</h3><Link className = "butttonlink" to='/User'><button>Learn More</button></Link><div className="vid2"></div></div>
            <div className="boximg1"><h2>Conferences & Seminars</h2><h3>Keep it all together at the venue</h3><Link className = "butttonlink" to='/USerPage'><button>Learn More</button></Link><div className="vid1"></div></div>
                <div className="boximg3"><h2>Team-Building Activities</h2><h3>Enhance teamwork through interactive experiences</h3><Link className = "butttonlink" to='/USerPage'><button>Learn More</button></Link><div className="vid3"></div></div>
            </div>
            </div>
            <Footer/>
        </div>
